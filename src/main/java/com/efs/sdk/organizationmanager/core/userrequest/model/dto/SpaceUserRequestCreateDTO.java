...
public class SpaceUserRequestCreateDTO {

    @Schema(description = "id of the user requesting access to space")
    private String userId;

    @Schema(description = "id of the organization the user is requesting access to")
    private Long orgaId;

    @Schema(description = "id of the space the user is requesting access to")
    private Long spaceId;

    @Schema(description = "role the user is requesting - defaults to &quot;USER&quot;")
    private RoleHelper.SpaceScopeRole role = RoleHelper.SpaceScopeRole.USER;
